...
$(function() {
    ...
    var wgwgImgFileUpload = document.querySelector('#wgwgImgFileUpload');
    wgwgImgFileUpload.addEventListener('change', function () {
        let files = $('#wgwgImgFileUpload')[0].files;
...
function displayThumbnails(imageUrls) {
    ...
    console.log('Displaying thumbnail : imageUrls.length:', imageUrls.length);
    for (let i = 0; i < imageUrls.length; i++) {
        ...
        htmlStr += '<div class="regist-upload-image" style="position: relative; display: inline-block;" data-index="' + imgIdx + '">' +
            ...
            '</div>';
        console.log('Displaying thumbnail:', imageUrl);
